                  ...
                  <Box>
                    ...
                    <div>
                            ...
                            <FormControl>
                                ...
                                <Input type='text' value={input.first_name} placeholder={newUser.first_name} name="first_name" onChange={handleInputChange} borderWidth='3px' />
                                ...
                                <Input type='text' value={input.last_name} placeholder={newUser.last_name} name="last_name" onChange={handleInputChange} borderWidth='3px' />
                                ...
                                <FormControl>
                                    ...
                                    <Input type='text' value={input.mobile} placeholder={newUser.mobile} name="mobile" onChange={handleInputChange} borderWidth='3px' />
